...
exports.genre_list = function(req, res) {
    Genre.find({})
        ...
        .exec(function(err, results) {
            ...
            res.render('genre_list', {title: 'Genre List', error: err, genre_list: results})
    })
};
...
exports.genre_update_post = [
  ...
  body('name', 'must enter a name').trim().isLength({min: 1}),
  sanitizeBody('name').escape(),
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      res.render('genre_form', { title: 'Update Genre', genre: this.genre_list, errors: errors.array()})
    return;
    } else {
